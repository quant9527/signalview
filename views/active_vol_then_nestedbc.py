...
# ============================================================================
# active_vol_then_nestedbc
#
# 模式说明：
# 筛选5m和15m出现 active_vol_then_nestedbc 信号的标的，等待回调见底机会
# ============================================================================
...
DISPLAY_SIGNAL_NAME = "active_vol_then_nestedbc"  # 页内展示用
...
# ============================================================================
# 筛选 5m 和 15m 的 active_vol_then_nestedbc 系列信号
# ============================================================================
...
if target_all_count > 0 and filtered_df.empty and 'freq' in df.columns:
    ...
    st.info(f"💡 本页只显示 **5m / 15m** 的 active_vol_then_nestedbc。库中共 {target_all_count} 条，但周期多为：{sample_freqs}，故当前筛选结果为 0。可放宽侧栏时间范围或确认数据源是否产出 5m/15m。")
